...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug 17 04:10:04 2022
...
loader = datasets.IEMOCAP_loader() # choose IEMOCAP_loader() or EmoDB_loader()
...
best_model = models.TFNN_for_SER_tm()
...
predictions, true_labels, times = mlt.get_pred_true_multi_dataloaders_tm(best_model, test_dataloaders, device=device)
